...
MACRO_CONFIG_INT(SvPlayerSlots, sv_player_slots, 24, 0, MAX_PLAYERS, CFGFLAG_SAVE | CFGFLAG_SERVER, "Number of slots to reserve for players")
...
MACRO_CONFIG_INT(SvVoteKickMin, sv_vote_kick_min, 0, 0, MAX_PLAYERS, CFGFLAG_SAVE | CFGFLAG_SERVER, "Minimum number of players required to start a kick vote")
...
MACRO_CONFIG_INT(DbgDummies, dbg_dummies, 0, 0, MAX_PLAYERS, CFGFLAG_SERVER, "")
#endif
